...
const API_KEY = "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";
const generateImage = async (
  ...
  if (!selectedModel) {
    console.error("Error: selectedModel is not defined.");
    return;
  }
